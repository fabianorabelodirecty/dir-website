...
import { version, year } from "../../config/versionControl";

const Footer: React.FC = () => {
    return (
        <>
            <div className="w-full max-w-[1280px] px-4 text-center my-10 flex flex-col gap-6 bg-black pb-10 xl:pb-0">
                ...
                <div className="text-left border-t border-white/10 pt-6 flex flex-col xl:flex-row  justify-between gap-6">
                    <div>
                ...
                <div className="mt-10">
                    <p className="text-xs opacity-50">
                        Copyright © {year}. Directy. Todos os direitos reservados.{" "}
