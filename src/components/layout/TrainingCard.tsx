    ...
    return (
        <>
            <div className="flex flex-col gap-6">
                <div className="flex flex-col gap-6 lg:max-w-[50%] mx-auto mb-14">
                ...
                <div className="flex flex-row gap-6">
                    <div className="flex flex-col gap-6">
                        ...
                        <Link
                            to={training.page}
                            className="rounded-full px-6 py-2 border white text-white w-fit hover:opacity-50 transition-all"
                        >
                            Saiba mais
                        </Link>
                    </div>
                    <div className="w-[80svw] bg-gray-500 rounded-lg p-1">
