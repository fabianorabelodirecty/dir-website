        ...
        <>
            <form onSubmit={handleSubmit} className="flex flex-col lg:flex-row gap-10">
                ...
                <div className="flex-[1.5] my-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 gap-x-8 w-full">
                ...
                <button
                    disabled={isLoading}
                    className="rounded-full px-6 py-2 lg:aspect-square text-white hover:opacity-50 transition-all my-auto disabled:opacity-10"
