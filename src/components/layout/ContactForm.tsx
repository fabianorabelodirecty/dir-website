        ...
        <>
            <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-10">
                ...
                <div className="flex-[1.5] my-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 gap-x-8 w-full">
                ...
                <button
                    disabled={isLoading}
                    className="rounded-full px-6 py-2 md:aspect-square text-white hover:opacity-50 transition-all my-auto disabled:opacity-10"
